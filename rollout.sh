...
if [ -z "$VALIDATE_ANSWER_SETS" ]; then
	VALIDATE_ANSWER_SETS="false"
fi
export COLLECT_OS_DATA COLLECT_DATA_PERIOD VALIDATE_ANSWER_SETS
...
echo "VALIDATE_ANSWER_SETS: $VALIDATE_ANSWER_SETS"
